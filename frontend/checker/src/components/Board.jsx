...
const Board = () => {
  ...
  const  switchPlayer =  () => {
    ...
    const gameState = axios.get("/state");
    console.log("grabbed gameState: " + gameState)
    const redWins = document.getElementById("redWin")
    const blueWins = document.getElementById("blueWin")

    if (gameState === "Red wins!"){
      redWins.style.visibility = "visible";
      console.log("red should have won");
    }
    if (gameState === "Blue wins!"){
      blueWins.style.visibility = "visible";
      console.log("blue should have won");
    }
